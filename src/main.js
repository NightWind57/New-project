const OLD_LIBRARY_KEY = "chargerBuyerShowCopyLibrary.v1";
    ...
    function saveGeneratedEdit(item, card) {
      ...
      recordEditFeedback("generated", item.content, value);
      item.content = value;
    ...
    function saveMaterialEdit(item, card) {
      ...
      recordEditFeedback("material", item.content, value);
      item.content = value;
      item.editing = false;
      item.draft = "";
      saveMaterials();
    ...
    function recordEditFeedback(type, before, after) {
      ...
      state.editFeedbackHistory = state.editFeedbackHistory.slice(0, 80);
